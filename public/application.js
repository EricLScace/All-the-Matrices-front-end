...
var post = function post(msg, loc) {
  if (arguments.length === 1) loc = 'announcement';
  // Erase & insert the requested announcement in the proper language.
  $('#' + loc).html(msg);
};
...
var alreadyRegistered = 'This email address is already registered. Attempting to log you in…';
var andWord = 'and ';
var badEmailPassword = 'This email or password was not recognized. Please try again, or re-register.';
var changingPassword = 'Changing your password…';
var loginFailUnknownCause = 'Sorry! Logging in failed mysteriously ☹️ — try again, or try later.';
var loggingIn = 'Logging you in…';
var loggingOut = 'Logging you out…';
var loginToOwn = 'Logged-in users may register the number of sets of this matrix they own.';
var lookingUpMatrix = 'Looking up this matrix code…';
var matrixGetFailed = 'Sorry! The matrix code look-up failed mysteriously ☹️ — try again, or try later.';
var matrixSetQuantityUpdated = 'Matrix set quantity updated.';
var matrixSetQuantityUpdateFailed = 'Sorry! The update of the number of matrix sets owned failed mysteriously ☹️ — try again, or try later.';
var noPrefixSuffix = 'Please enter both the suffix & prefix codes from the matrix.';
var noEmail = 'Please enter your email address.';
var noOldPassword = 'Please enter your current password.';
var noPassword = 'Please enter your new password twice identically.';
var notInDatabase = 'Code not yet in this database (or was never manufactured).';
var notPositiveInteger = 'Please enter a positive integer.';
var otherServerError = 'Database not available. Please try again later.';
var ownerMsg = function ownerMsg(matrixInfo) {
...
var passwordChangeFailed = 'Sorry! Registration failed mysteriously ☹️ — please try again later.';
var registeredOK = 'Registered successfully! Please log in.';
var registering = 'Registering you…';
var registrationFailed = 'Sorry! Registration failed mysteriously ☹️ — try again or log-in with a different account.';
var unequalPassword = 'Your new password entries are not identical; please re-enter both.';
var userInfo = function userInfo() {
  var str = store.user.name ? store.user.name : store.user.email;
...
module.exports = {
  ...
  andWord: andWord,
  badEmailPassword: badEmailPassword,
  changingPassword: changingPassword,
  loginFailUnknownCause: loginFailUnknownCause,
  loggingIn: loggingIn,
  loggingOut: loggingOut,
  loginToOwn: loginToOwn,
  lookingUpMatrix: lookingUpMatrix,
  matrixGetFailed: matrixGetFailed,
  matrixSetQuantityUpdated: matrixSetQuantityUpdated,
  matrixSetQuantityUpdateFailed: matrixSetQuantityUpdateFailed,
  noEmail: noEmail,
  ...
  unequalPassword: unequalPassword,
  userInfo: userInfo,
  withWord: withWord
};
...
var changePassword = function changePassword(creds) {
  return $.ajax({
...
var announceUI = __webpack_require__(3);
var getMatrixTemplate = __webpack_require__(10);
var loggedInForm = __webpack_require__(38);
var logInRegisterButtons = __webpack_require__(12);
var msg = __webpack_require__(4);

// Display logged-in condition & matrix request form
var postLoggedInUserWorkingView = function postLoggedInUserWorkingView() {
...
var postPublicUserWorkingView = function postPublicUserWorkingView() {
  announceUI.clear('announcement');
...
var validateProposedPassword = function validateProposedPassword(user) {
  var isPasswordOK = true;
  // Both fields must be present
  if (user.password === '' || user.password === undefined || user.passwordConfirmation === '' || user.passwordConfirmation === undefined) {
...
module.exports = {
  postLoggedInUserWorkingView: postLoggedInUserWorkingView,
  postPublicUserWorkingView: postPublicUserWorkingView,
  validateProposedPassword: validateProposedPassword
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- Get Matrix form HTML -->\n<form id='get-matrix'>\n  Enter matrix code:\n  <input type='text' name='matrix[code_prefix]' class='code-prefix'>\n  Δ\n  <input type='text' name='matrix[code_suffix]'>\n  <input id='matrix-request' type='submit' name='submit' value='Look up'>\n</form>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class='register col-xs-offset-9 col-xs-3'>\n  <input type='button' id='register-request' value='Register'>\n  <input type='button' id='log-in-request' value='Log in'>\n</div>\n";
},"useData":true});
...
var announceUI = __webpack_require__(3);
var authnAPI = __webpack_require__(8);
var authnUtilities = __webpack_require__(9);
var getFormFields = __webpack_require__(7);
var msg = __webpack_require__(4);
var loginForm = __webpack_require__(39);
var store = __webpack_require__(1);

var loginAPICall = function loginAPICall(credentials) {
  authnAPI.logIn(credentials).then(success).catch(failure);
};
...
var success = function success(response) {
  ...
  store.user.setLogInStatus(true, response.user.email, null, response.user.id, response.user.token, response.user.name, response.user.organization);
...
var config = __webpack_require__(11);
var matrixAPIversion = '1.0';
var store = __webpack_require__(1);

var show = function show(matrix) {
  matrix.symbol = 'Δ';
...
var update = function update(matrixUpdate) {
  return $.ajax({
    url: config.apiOrigin + '/matrix',
    method: 'PATCH',
    headers: {
...
var getMatrixTemplate = __webpack_require__(10);
var msg = __webpack_require__(4);
var setUpdateForm = __webpack_require__(47);
var store = __webpack_require__(1);

var displayMatrix = function displayMatrix(response) {
  announceUI.clear('announcement');
  var matrixInfo = response.matrix;
...
var authnDispatchUI = __webpack_require__(21);
var config = __webpack_require__(11);
var matrixDispatchUI = __webpack_require__(45);
var setAPIOrigin = __webpack_require__(49);
var store = __webpack_require__(1);
...
var authnLoginUI = __webpack_require__(13);
var authnLogoutUI = __webpack_require__(40);
var authnRegisterUI = __webpack_require__(41);
var authnSettingsUI = __webpack_require__(43);
var authnUtilitiesUI = __webpack_require__(9);
var logInRegisterButtons = __webpack_require__(12);
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "  <div id='logged-in-user' class='logged-in-user col-xs-offset-2 col-xs-7'>\n  </div>\n  <div class='logged-in-buttons col-xs-3'>\n    <span id='change-settings-request' class='icon fa fa-cog'></span>\n    <input type='button' id='log-out-request' value='Log out'>\n  </div>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class='log-in col-xs-offset-2 col-xs-7'>\n  <form id='log-in'>\n      <input type='email'\n        name='email' placeholder='email'>\n      <br>\n      <input type='password' name='password' placeholder='password'>\n      <br>\n      <input id='log-in-submit' type='submit' name='submit' value='Log in'>\n      <input id='cancel-request' type='button' value='Cancel'>\n  </form>\n</div>\n\n<div class='register col-xs-3'>\n  <input type='button' id='register-request' value='Register'>\n  <input type='button' id='log-in-request' value='Log in'>\n</div>\n";
},"useData":true});
...
var onRequest = function onRequest() {
  ...
  authnAPI.logOut().then(success).catch(failure);
};
...
var announceUI = __webpack_require__(3);
var authnAPI = __webpack_require__(8);
var authnLogin = __webpack_require__(13);
var authnUtilities = __webpack_require__(9);
var getFormFields = __webpack_require__(7);
var msg = __webpack_require__(4);
var registerForm = __webpack_require__(42);
var store = __webpack_require__(1);
// Extracts fields buried inside the registration form object
var extractFormFields = function extractFormFields(APIObject, user) {
...
var onSubmit = function onSubmit(e) {
  ...
  var credentialsAPIObject = getFormFields(e.target.form);
  ...
  if (validateCredentials(store.user)) {
    ...
    authnAPI.register(credentialsAPIObject).then(success).catch(failure);
  }
};
...
var validateCredentials = function validateCredentials(user) {
  ...
  var isValid = authnUtilities.validateProposedPassword(user);
...
var getFormFields = __webpack_require__(7);
var msg = __webpack_require__(4);
var changeSettings = __webpack_require__(44);
var store = __webpack_require__(1);
...
var onPasswordSubmit = function onPasswordSubmit(e) {
  e.preventDefault();
  // Clear old error messages, if any.
  announceUI.clear('announcement');
  // Get the form's contents
  ...
  if (validateCredentials(store.user)) {
    ...
    authnAPI.changePassword(credentialsAPIObject).then(success).catch(failure);
  }
};
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- Change settings HTML -->\n<div class='change-password col-xs-offset-2 col-xs-5'>\n  <form id=\"change-password\">\n      <input type='password' name='credentials[old]' placeholder='current password'>\n      <br>\n      <input type='password' name='credentials[new]' placeholder='new password'>\n      <br>\n      <input type='password' name='credentials[new_confirmation]' placeholder='confirm password'>\n      <br>\n      <input type=\"submit\" id=\"change-password-submit\" name=\"submit\" value=\"Change\">\n      <input type=\"button\" id=\"change-settings-cancel\" value=\"Cancel\">\n  </form>\n</div>\n\n<div id='logged-in-user' class='logged-in-user col-xs-2'>\n</div>\n\n<div class='logged-in-buttons col-xs-3'>\n  <span id='change-settings-request' class='icon fa fa-cog'></span>\n  <input type='button' id='log-out-request' value='Log out'>\n</div>\n";
},"useData":true});
...
var getMatrix = __webpack_require__(46);
var getMatrixTemplate = __webpack_require__(10);
var matrixOwn = __webpack_require__(48);
...
var getFormFields = __webpack_require__(7);
var getMatrixTemplate = __webpack_require__(10);
var matrixAPI = __webpack_require__(16);
var matrixUtiltiesUI = __webpack_require__(17);
var msg = __webpack_require__(4);
...
var onRequest = function onRequest(e) {
  e.preventDefault();
  var matrix = getFormFields(e.target.form).matrix;
  // Some input?
  ...
  if (matrix.code_prefix === '' || matrix.code_suffix === '') {
    ...
    matrixAPI.show(matrix).then(success).catch(failure);
  }
};
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "  <form id='set-update'>\n    <fieldset>\n      <p>I have:\n        <input type='number' class='number' name='quantity' placeholder='how many sets?'>\n        <input id='update-sets-submit' type='submit' name='submit' value='Update'>\n      </p>\n    </fieldset>\n  </form>\n";
},"useData":true});
...
var onUpdate = function onUpdate(e) {
  ...
  if (validateQuantity(store.matrix.quantity)) {
    matrixAPI.update(store.matrix).then(success).catch(failure);
  }
};
...
// Else return false
var validateQuantity = function validateQuantity(quantity) {
...
var parseNestedQuery = __webpack_require__(50);
...
var User = function User(isLoggedIn, email, password, id, authNToken, name, org) {
